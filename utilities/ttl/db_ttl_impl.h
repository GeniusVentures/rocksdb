...
class DBWithTTLImpl : public DBWithTTL {
 public:
  ...
  static constexpr uint32_t kTSLength = sizeof(int32_t);  // size of timestamp

  static constexpr int32_t kMinTimestamp = 1368146402;  // 05/09/2013:5:40PM GMT-8

  static constexpr int32_t kMaxTimestamp = 2147483647;  // 01/18/2038:7:14PM GMT-8
